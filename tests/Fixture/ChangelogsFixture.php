<?php
namespace Gerrymcdonnell\Changelog\Test\Fixture;
...
class ChangelogsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'changelog_category_id' => ['type' => 'integer', 'length' => 11, 'unsigned' => false, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
    ...
    public $records = [
        [
            ...
            'changelog_category_id' => 1,
            'description' => 'Lorem ipsum dolor sit amet, aliquet feugiat. Convallis morbi fringilla gravida, phasellus feugiat dapibus velit nunc, pulvinar eget sollicitudin venenatis cum nullam, vivamus ut a sed, mollitia lectus. Nulla vestibulum massa neque ut et, id hendrerit sit, feugiat in taciti enim proin nibh, tempor dignissim, rhoncus duis vestibulum nunc mattis convallis.',
            'priority' => 1,
            'url' => 'Lorem ipsum dolor sit amet',
            'status' => 1,
            'user_id' => 1,
            'created' => '2016-12-19 23:58:24',
            'modified' => '2016-12-19 23:58:24'
        ],
    ];
}
